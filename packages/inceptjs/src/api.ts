...
export const data: {
  fields: Record<string, Record<string, ColumnFieldOption>>,
  validators: Record<string, Record<string, ColumnValidationOption>>,
  formats: Record<string, Record<string, ColumnFormatOption>>
} = {
  fields: {
    '': {
      none: {
